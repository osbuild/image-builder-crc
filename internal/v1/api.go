...
// Valid indicates whether the value is a known member of the CloneStatusResponseStatus enum.
func (e CloneStatusResponseStatus) Valid() bool {
	switch e {
	case CloneStatusResponseStatusFailure:
		return true
	case CloneStatusResponseStatusPending:
		return true
	case CloneStatusResponseStatusRunning:
		return true
	case CloneStatusResponseStatusSuccess:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the GetSourceListParamsProvider enum.
func (e GetSourceListParamsProvider) Valid() bool {
	switch e {
	case Aws:
		return true
	case Azure:
...
type SourceUploadInfoResponse struct {
	...
	Gcp      interface{} `json:"gcp,omitempty"`
	Provider *string     `json:"provider,omitempty"`
}
