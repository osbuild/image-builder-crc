...
type ApiContentUnitSearchRequest struct {
	...
	// IncludePackageSources Whether to include module information
	IncludePackageSources *bool `json:"include_package_sources,omitempty"`
...
type ApiPackageSourcesResponse struct {
	...
	// EndDate End date of the lifecycle
	EndDate *string `json:"end_date,omitempty"`

	// Name Name of the module
	Name *string `json:"name,omitempty"`

	// StartDate Start date of the lifecycle
	StartDate *string `json:"start_date,omitempty"`

	// Stream Stream of the module
	Stream *string `json:"stream,omitempty"`

	// Type Type of rpm (can be either 'package' or 'module')
...
type ApiSearchRpmResponse struct {
	...
	// PackageSources List of the module streams for the package
	PackageSources *[]ApiPackageSourcesResponse `json:"package_sources,omitempty"`
...
// rhIdentityContextKey is the context key for RhIdentity security scheme
type rhIdentityContextKey string
