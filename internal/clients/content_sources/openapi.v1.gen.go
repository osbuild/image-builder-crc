...
// ApiModuleInfoResponse defines model for api.ModuleInfoResponse.
type ApiModuleInfoResponse struct {
...
type ApiSearchRpmResponse struct {
	...
	PackageSources *[]ApiModuleInfoResponse `json:"package_sources,omitempty"`
