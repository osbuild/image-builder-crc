...
func (e UploadStatusValue) Valid() bool {
	switch e {
	case UploadStatusValueFailure:
		return true
	case UploadStatusValuePending:
		return true
	case UploadStatusValueRunning:
		return true
	case UploadStatusValueSuccess:
		return true
	default:
		return false
	}
...
// BlueprintFileGroup0 defines model for BlueprintFile.Group.0.
type BlueprintFileGroup0 = string

// BlueprintFileGroup1 defines model for BlueprintFile.Group.1.
...
// BlueprintFileUser0 defines model for BlueprintFile.User.0.
type BlueprintFileUser0 = string

// BlueprintFileUser1 defines model for BlueprintFile.User.1.
...
type BlueprintRepository struct {
	...
	// Mirrorlist Example: http://mirrorlist.centos.org/?release=8-stream&arch=aarch64&repo=BaseOS
...
type Bootc struct {
	...
	//
	//
	// Example: quay.io/centos-bootc/centos-bootc-build:stream9
	...
	// Reference Example: quay.io/centos-bootc/centos-bootc:stream9
...
// ComposeStatusValue Example: success
...
type Koji struct {
	// Name Example: Fedora-Cloud-Base
	Name string `json:"name"`

	// Release Example: 20200907.0
	Release string `json:"release"`

	// Server Example: https://koji.fedoraproject.org/kojihub
...
type User struct {
	...
	// Key Example: ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAINrGKErMYi+MMUwuHaRAJmRLoIzRf2qD2dD5z0BTx/6x
	Key *string `json:"key,omitempty"`
